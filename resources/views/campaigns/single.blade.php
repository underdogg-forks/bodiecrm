...
@section('subtitle')
    @if ( ! $campaign->active )
        <span data-tooltip aria-haspopup = "true" class = "has-tip tip-right" title = "{{ Lang::get('campaign.archived') }}"><i class = "fa fa-lock"></i></span>
    @endif
...
@section('links')
    ...
    <button class = "button small radius comment-button"><i class = "fa fa-commenting"></i>{{ $campaign->comments->count() }}</button>
@stop
