        ...
        <div class = "panel" data-equalizer-watch>
            ...
            <div class = "row">
                ...
                @else
                    ...
                    <div id = "landing_page_list_chart_{{ $landing_page->id }}" class = "landing_page_list_chart_item panel animated fadeIn text-center">
            ...
            <div class = "landing_page_list_owner row">
                ...
                <div class = "icons small-6 columns text-right">
                    @if ( $landing_page->send_email == 1 )
                        <span data-tooltip aria-haspopup = "true" class = "has-tip tip-top" title = "{{ Lang::get('landing_page.email') }}"><i class = "fa fa-envelope"></i></span>
                    @endif
                    <span data-tooltip aria-haspopup = "true" class = "has-tip tip-top" title = "{{ Lang::get('landing_page.comments') }}"><i class = "fa fa-comments"></i> {{ number_format($landing_page->comments->count()) }}</span>
                    <span data-tooltip aria-haspopup = "true" class = "has-tip tip-top" title = "{{ Lang::get('landing_page.total_lead_count') }}"><i class = "fa fa-file-text-o"></i> {{ number_format($landing_page->leads->count()) }}</span>
                </div>
            </div>
        </div>
    </div>
