<div id = "leads_links">
    <div class = "lead_follow inline">
        ...
        <button class = "button small unwatch" data-url = "{{ url('leads/' . $lead->id . '/unwatch') }}" data-csrf = "{!! csrf_token() !!}">
            {!! csrf_field() !!}
            <i class = "fa fa-star"></i>Unwatch
        </button>
        @else
        <button class = "button small watch" data-url = "{{ url('leads/' . $lead->id . '/watch') }}" data-csrf = "{!! csrf_token() !!}">
            <i class = "fa fa-star"></i>Watch</button>
        @endif
    ...
    <div class = "inline">
        <button href = "#" data-dropdown = "drop1" aria-controls = "drop1" aria-expanded = "false" class = "button radius dropdown tiny">
    ...
    <button class = "button small radius comment-button"><i class = "fa fa-commenting"></i>{{ $lead->comments->count() }}</button>
</div>