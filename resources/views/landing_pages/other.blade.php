...
<div class="small-6 columns">
  <strong><span data-tooltip aria-haspopup="true" class="has-tip tip-right"
                title="{{ Lang::get('landing_page.auth_key') }}">Authentication key <i
        class="fa fa-question-circle"></i> :</span></strong>
  {{ $landing_page->auth_key }}
</div>
<div class="small-6 columns">
  <strong><span data-tooltip aria-haspopup="true" class="has-tip tip-right"
                title="{{ Lang::get('landing_page.return_url') }}">Return URL <i
        class="fa fa-question-circle"></i> :</span></strong> <a href="{{ $landing_page->return_url }}"
                                                                target="_blank">{{ $landing_page->return_url }}</a>
</div>
<div class="small-6 columns">
