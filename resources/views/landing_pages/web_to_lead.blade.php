...
@section('content')
  <div id="landing_page_single_web_to_lead" class="row">
    <div class="small-12 columns">
      <p>
        The <span data-tooltip aria-haspopup="true" class="has-tip tip-right"
                  title="{{ Lang::get('landing_page.w2l') }}">web to lead <i class="fa fa-question-circle"></i></span>
        form code to be placed on your web page, in order to capture lead submissions.
      </p>

      <p>
        Please note: Lead submissions will be validated after submission, but you should always implement some checks
        before allowing users to submit as well.
      </p>
